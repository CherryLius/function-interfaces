 ...
 * {@link jdk8.function.Function} (unary function from {@code T} to {@code R}),
 * {@link jdk8.function.Consumer} (unary function from {@code T} to {@code void}),
 * {@link jdk8.function.Predicate} (unary function from {@code T} to {@code boolean}),
 * and {@link jdk8.function.Supplier} (nilary function to {@code R}).
 * </li>
 * <p>
 ...
 * {@link jdk8.function.BiFunction} (binary function from {@code T} and
 * {@code U} to {@code R}).
 * </li>
 * <p>
 * <li>There are additional derived function shapes which extend the basic
 * function shapes, including {@link jdk8.function.UnaryOperator}
 * (extends {@code Function}) and {@link jdk8.function.BinaryOperator}
 ...
 * prefix {@code ToXxx}, as in {@link jdk8.function.ToIntFunction}.
 * Otherwise, type arguments are specialized left-to-right, as in
 * {@link jdk8.function.DoubleConsumer}
 * or {@link jdk8.function.ObjIntConsumer}.
 ...
 * as in {@link jdk8.function.ObjIntConsumer}.)
 ...
 * prefix may be left out (as in {@link jdk8.function.ObjIntConsumer}).
 * </li>
 * </ul>
 *
